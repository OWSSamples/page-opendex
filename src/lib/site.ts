...
export const siteRoutes: SiteRoute[] = [
  ...
  },
  {
    path: "/legal",
    title: "Legal Opendex",
    description: "Indice de politicas legales de Opendex Web Services.",
    priority: 0.4,
    changeFrequency: "monthly",
  },
  {
  ...
  },
  {
    ...
    description: "Tratamiento de informacion personal y derechos de privacidad de Opendex.",
    priority: 0.4,
    changeFrequency: "monthly",
  },
  {
    ...
    description: "Categorias de cookies, consentimiento y preferencias de privacidad.",
    priority: 0.4,
    changeFrequency: "monthly",
  },
];
