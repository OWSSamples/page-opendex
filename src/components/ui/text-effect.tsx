...
// Source: motion-primitives — github.com/ibelick/motion-primitives
// Adapted for this project: import path for cn updated, no icon dependency.
...
export function TextEffect({
  ...
  const computedVariants = {
    ...
    item: createVariantsWithTransition(
      ...
      { duration: baseDuration, ...segmentTransition },
    ),
  };
