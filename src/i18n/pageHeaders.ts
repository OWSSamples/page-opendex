...
export const pageHeaders: Record<Locale, PageHeaderDictionary> = {
  es: {
    ...
    security: {
      eyebrow: "Seguridad",
      title: "Seguridad clara para operar con confianza.",
      description:
        "Acceso, privacidad, trazabilidad y continuidad explicados con la claridad que necesitan equipos de producto, operación, legal y TI.",
    },
    status: {
      eyebrow: "Status",
  ...
  en: {
    ...
    security: { eyebrow: "Security", title: "Clear security for teams that operate with confidence.", description: "Access, privacy, traceability and continuity explained with the clarity product, operations, legal and IT teams need." },
  ...
  pt: {
    ...
    security: { eyebrow: "Segurança", title: "Segurança clara para operar com confiança.", description: "Acesso, privacidade, rastreabilidade e continuidade explicados com a clareza que produto, operações, jurídico e TI precisam." },
  ...
  fr: {
    ...
    security: { eyebrow: "Sécurité", title: "Une sécurité claire pour fonctionner avec confiance.", description: "Accès, confidentialité, traçabilité et continuité expliqués avec la clarté nécessaire aux équipes produit, opérations, juridique et IT." },
  ...
  zh: {
    ...
    security: { eyebrow: "安全", title: "用清晰安全能力支持可信运营。", description: "以产品、运营、法务和 IT 团队都能理解的方式说明访问、隐私、可追踪性和连续性。" },
